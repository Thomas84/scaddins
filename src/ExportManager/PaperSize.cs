...
namespace SCaddins.ExportManager
{
    ...
    public class PaperSize
    {
        ...
        public PaperSize (string formatedPaperSizeString)
        {
        ...
        public PaperSize (double width, double height)
        {
            Width = width;
            Height = height;
            Name = PaperSize.GetNameByDimensions(Width, Height);
            GhostScriptName = PaperSize.GetGhostscriptPrinterName(Name);
        }
        ...
        {             
            ...
            foreach (string s in PaperSize.AvailableGhostScriptPageSizes) {
                if (s.Contains(test)) {
                    return test;
                }
            }
